...
class DataUtils {
    ...
    suspend fun generateNews(): List<NewsItem> {
        val darwinAwards = Category(1, "Darwin Awards")
        val criminal = Category(1, "Criminal")
        val animals = Category(2, "Animals")
        val music = Category(3, "Music")
        _progress.value = 0
    ...
    companion object {
        fun createDate(year: Int, month: Int, date: Int, hrs: Int, min: Int)
                = GregorianCalendar(year, month - 1, date, hrs, min).time
    }
}